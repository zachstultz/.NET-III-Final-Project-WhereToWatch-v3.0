        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (!userAccessor.CheckForExistanceOfUserByEmail(model.Email))
                    {
                        User desktopGeneratedUser = new User(10000, "generated", "generated", "5155555555", model.Email,
                            new List<string>() {"User"});
                        userAccessor.InsertNewUser(desktopGeneratedUser);
                    }
