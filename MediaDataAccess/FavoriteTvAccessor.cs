...
namespace DataAccessLayer
{
    ...
    ///     The tv accessor.
    /// </summary>
    public class FavoriteTvAccessor : IFavoriteTvAccessor
    {
        /// <summary>
        ///     Zach Stultz
        ///     Created: 2021/05/06
        ...
        public bool InsertTvShow(Tv tv, User user)
        {
            bool result = false;

            var conn = DbConnection.GetDbConnection();
            var cmd = new SqlCommand("sp_insert_favorite_tv_show", conn) { CommandType = CommandType.StoredProcedure };
        ...
        /// <param name="user"></param>
        /// <returns>A bool.</returns>
        public int DeleteTvShow(int id, User user)
        {
            int result;
            var conn = DbConnection.GetDbConnection();
            var cmd = new SqlCommand("sp_delete_favorite_tv_show", conn) {CommandType = CommandType.StoredProcedure};
            cmd.Parameters.Add("@TvId", SqlDbType.Int);
        ...
        /// <param name="user"></param>
        /// <returns>A bool.</returns>
        public int UpdateTvShow(Tv oldTv, Tv newTv, User user)
        {
            int result;

            var conn = DbConnection.GetDbConnection();
            var cmd = new SqlCommand("sp_update_favorite_tv_show", conn) { CommandType = CommandType.StoredProcedure };
        ...
        public List<Tv> SelectAllTvShows()
        {
            ...
            var conn = DbConnection.GetDbConnection();
            var cmd = new SqlCommand("sp_select_all_favorite_tv_shows", conn) { CommandType = CommandType.StoredProcedure };
        ...
        public List<Tv> SelectAllTvShowsByUserId(User user)
        {
            var conn = DbConnection.GetDbConnection();
            var cmd = new SqlCommand("sp_retrieve_favorite_tv_show_by_id", conn) { CommandType = CommandType.StoredProcedure };
            cmd.Parameters.Add("@UserId", SqlDbType.Int);
            cmd.Parameters["@UserId"].Value = user.UserId;
            List<Tv> tvShows = new List<Tv>();
                ...
                if (reader.HasRows)
                {
                    while (reader.Read())
                    {
                        Tv foundTvShow = new Tv()
                        {
                            ...
                            Changes = reader.GetString(5),
                            ContentRatings = reader.GetString(6),
                            CreatedBy = reader.GetString(7),
                            Credits = reader.GetString(8),
                            EpisodeRunTime = reader.GetInt32(9),
                            ExternalIds = reader.GetString(10),
                            FirstAirDate = reader.GetDateTime(11),
                            GenreIds = reader.GetInt32(12),
                            Genres = reader.GetString(13),
                            Homepage = reader.GetString(14),
                            Images = reader.GetString(15),
                            InProduction = reader.GetBoolean(16),
                            Keywords = reader.GetString(17),
                            Languages = reader.GetString(18),
                            LastAirDate = reader.GetDateTime(19),
                            LastEpisodeToAir = reader.GetString(20),
                            Name = reader.GetString(21),
                            NextEpisodeToAir = reader.GetString(22),
                            Networks = reader.GetString(23),
                            NumberOfEpisodes = reader.GetInt32(24),
                            NumberOfSeasons = reader.GetInt32(25),
                            OriginalLanguage = reader.GetString(26),
                            OriginalName = reader.GetString(27),
                            OriginCountry = reader.GetString(28),
                            Overview = reader.GetString(29),
                            Popularity = reader.GetDouble(30),
                            PosterPath = reader.GetString(31),
                            ProductionCompanies = reader.GetString(32),
                            Recommendations = reader.GetString(33),
                            Reviews = reader.GetString(34),
                            Seasons = reader.GetString(35),
                            Similar = reader.GetString(36),
                            Status = reader.GetString(37),
                            Translations = reader.GetString(38),
                            Type = reader.GetString(39),
                            Videos = reader.GetString(40),
                            VoteAverage = reader.GetDouble(41),
                            VoteCount = reader.GetInt32(42),
                        };
                        tvShows.Add(foundTvShow);
                    }
        ...
        public bool CheckForExistanceCheckForTvShowByIdAndUserId(int id, User user)
        {
            var conn = DbConnection.GetDbConnection();
