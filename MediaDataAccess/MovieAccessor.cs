...
namespace DataAccessLayer
{
    ...
    public class MovieAccessor : IMovieAccessor
    {
        ...
        public bool InsertMovie(Movie movie)
        {
            ...
            var cmd = new SqlCommand("sp_insert_movie", conn) {CommandType = CommandType.StoredProcedure};
        ...
        public int DeleteMovie(int id)
        {
            int result;
            var conn = DbConnection.GetDbConnection();
            var cmd = new SqlCommand("sp_delete_movie", conn) {CommandType = CommandType.StoredProcedure};
        ...
        public int UpdateMovie(Movie oldMovie, Movie newMovie)
        {
            ...
            var conn = DbConnection.GetDbConnection();
            var cmd = new SqlCommand("sp_update_movie", conn) {CommandType = CommandType.StoredProcedure};
        ...
        public List<Movie> SelectAllMovies()
        {
            ...
            var conn = DbConnection.GetDbConnection();
            var cmd = new SqlCommand("sp_select_all_movies", conn) {CommandType = CommandType.StoredProcedure};
        ...
        {
            var conn = DbConnection.GetDbConnection();
            var cmd = new SqlCommand("sp_retrieve_movie_by_id", conn) {CommandType = CommandType.StoredProcedure};
            cmd.Parameters.Add("@MovieId", SqlDbType.Int);
            cmd.Parameters["@MovieId"].Value = id;
