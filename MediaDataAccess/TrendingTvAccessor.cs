...
namespace DataAccessLayer
{
    ...
    ///     The tv accessor.
    /// </summary>
    public class TrendingTvAccessor : ITrendingTvAccessor
    {
        /// <summary>
        ///     Zach Stultz
        ///     Created: 2021/05/06
        ...
        public bool InsertTvShow(Tv tv)
        {
            ...
            var cmd = new SqlCommand("sp_insert_trending_tv_show", conn) { CommandType = CommandType.StoredProcedure };
        ...
        public int UpdateTvShow(Tv oldTv, Tv newTv)
        {
            ...
            var conn = DbConnection.GetDbConnection();
            var cmd = new SqlCommand("sp_update_trending_tv_show", conn) { CommandType = CommandType.StoredProcedure };
        ...
        public List<Tv> SelectAllTvShows()
        {
            ...
            var conn = DbConnection.GetDbConnection();
            var cmd = new SqlCommand("sp_select_all_trending_tv_shows", conn) { CommandType = CommandType.StoredProcedure };
        ...
        {
            var conn = DbConnection.GetDbConnection();
            var cmd = new SqlCommand("sp_retrieve_trending_tv_show_by_id", conn) { CommandType = CommandType.StoredProcedure };
            cmd.Parameters.Add("@TvId", SqlDbType.Int);
