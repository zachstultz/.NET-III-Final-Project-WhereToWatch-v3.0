...
namespace DataAccessLayer
{
    ...
    ///     The movie accessor.
    /// </summary>
    public class FavoriteMovieAccessor : IFavoriteMovieAccessor
    {
        /// <summary>
        ///     Zach Stultz
        ///     Created: 2021/05/06
        ...
        public bool InsertMovie(Movie movie, User user)
        {
            bool result = false;

            var conn = DbConnection.GetDbConnection();
            var cmd = new SqlCommand("sp_insert_favorite_movie", conn) {CommandType = CommandType.StoredProcedure};
        ...
        /// <param name="user"></param>
        /// <returns>A bool.</returns>
        public int DeleteMovie(int id, User user)
        {
            int result = 0;
            var conn = DbConnection.GetDbConnection();
            var cmd = new SqlCommand("sp_delete_favorite_movie", conn) {CommandType = CommandType.StoredProcedure};
            cmd.Parameters.Add("@MovieId", SqlDbType.Int);
        ...
        /// <param name="user"></param>
        /// <returns>A bool.</returns>
        public int UpdateMovie(Movie oldMovie, Movie newMovie, User user)
        {
            int result;

            var conn = DbConnection.GetDbConnection();
            var cmd = new SqlCommand("sp_update_favorite_movie", conn) {CommandType = CommandType.StoredProcedure};
        ...
        public List<Movie> SelectAllMovies()
        {
            ...
            var conn = DbConnection.GetDbConnection();
            var cmd = new SqlCommand("sp_select_all_favorite_movies", conn) {CommandType = CommandType.StoredProcedure};
        ...
        /// <param name="user"></param>
        public List<Movie> SelectAllMoviesByUserId(User user)
        {
            var conn = DbConnection.GetDbConnection();
            var cmd = new SqlCommand("sp_retrieve_favorite_movie_by_id", conn) {CommandType = CommandType.StoredProcedure};
            cmd.Parameters.Add("@UserId", SqlDbType.Int);
            cmd.Parameters["@UserId"].Value = user.UserId;
                ...
                if (reader.HasRows)
                {
                    while (reader.Read())
                    {
                        Movie foundMovie = new Movie()
                        {
                            ...
                            AccountStates = reader.GetString(2),
                            Adult = reader.GetBoolean(3),
                            AlternativeTitles = reader.GetString(4),
                            BackdropPath = reader.GetString(5),
                            BelongsToCollection = reader.GetString(6),
                            Budget = reader.GetInt64(7),
                            Changes = reader.GetString(8),
                            Credits = reader.GetString(9),
                            Genres = reader.GetString(10),
                            Homepage = reader.GetString(11),
                            Images = reader.GetString(12),
                            ImdbId = reader.GetString(13),
                            Keywords = reader.GetString(14),
                            Lists = reader.GetString(15),
                            OriginalLanguage = reader.GetString(16),
                            OriginalTitle = reader.GetString(17),
                            Overview = reader.GetString(18),
                            Popularity = reader.GetDouble(19),
                            PosterPath = reader.GetString(20),
                            ProductionCompanies = reader.GetString(21),
                            ProductionCountries = reader.GetString(22),
                            ReleaseDate = reader.GetDateTime(23),
                            ReleaseDates = reader.GetString(24),
                            ExternalIds = reader.GetString(25),
                            Releases = reader.GetString(26),
                            Revenue = reader.GetInt64(27),
                            Reviews = reader.GetString(28),
                            Runtime = reader.GetInt32(29),
                            Similar = reader.GetString(30),
                            Recommendations = reader.GetString(31),
                            SpokenLanguages = reader.GetString(32),
                            Status = reader.GetString(33),
                            Tagline = reader.GetString(34),
                            Title = reader.GetString(35),
                            Translations = reader.GetString(36),
                            Video = reader.GetBoolean(37),
                            Videos = reader.GetString(38),
                            VoteAverage = reader.GetDouble(39),
                            VoteCount = reader.GetInt32(40)
                        };
        ...
        public Movie SelectMovieByIdAndUserId(int id, User user)
        {
            var conn = DbConnection.GetDbConnection();
            var cmd = new SqlCommand("sp_retrieve_favorite_tv_show_by_id_and_user_id", conn) { CommandType = CommandType.StoredProcedure };
            cmd.Parameters.Add("@MovieId", SqlDbType.Int);
            cmd.Parameters["@MovieId"].Value = id;
            cmd.Parameters.Add("@UserId", SqlDbType.Int);
            cmd.Parameters["@UserId"].Value = user.UserId;
        ...
        public bool CheckForExistanceOfMovieByIdAndUserId(int id, User user)
        {
            var conn = DbConnection.GetDbConnection();
            var cmd = new SqlCommand("sp_retrieve_favorite_movie_by_id_and_user_id", conn) { CommandType = CommandType.StoredProcedure };
            cmd.Parameters.Add("@MovieId", SqlDbType.Int);
            cmd.Parameters["@MovieId"].Value = id;
            cmd.Parameters.Add("@UserId", SqlDbType.Int);
            cmd.Parameters["@UserId"].Value = user.UserId;
